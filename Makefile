...
pkgdatadir = $(datadir)/isync
pkgincludedir = $(includedir)/isync
pkglibdir = $(libdir)/isync
pkglibexecdir = $(libexecdir)/isync
...
CONFIG_HEADER = autodefs.h
CONFIG_CLEAN_FILES = isync.spec
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/autodefs.h.in \
	$(srcdir)/isync.spec.in AUTHORS COPYING ChangeLog INSTALL NEWS \
...
ACLOCAL = ${SHELL} '/home/yizhi.fzh/isync-1.4.4/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/yizhi.fzh/isync-1.4.4/missing' autoconf
AUTOHEADER = ${SHELL} '/home/yizhi.fzh/isync-1.4.4/missing' autoheader
AUTOMAKE = ${SHELL} '/home/yizhi.fzh/isync-1.4.4/missing' automake-1.16
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -Wno-misleading-indentation -pipe -std=c11 -pedantic -Wall -Wextra -Wshadow -Wcast-qual -Wformat=2 -Wformat-signedness -Wformat-nonliteral -Wstrict-prototypes -Wno-overlength-strings -g
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} '/home/yizhi.fzh/isync-1.4.4/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = isync
PACKAGE_BUGREPORT = 
PACKAGE_NAME = isync
PACKAGE_STRING = isync 1.4.4
...
VERSION = 1.4.4
Z_LIBS = -lz
abs_builddir = /home/yizhi.fzh/isync-1.4.4
abs_srcdir = /home/yizhi.fzh/isync-1.4.4
abs_top_builddir = /home/yizhi.fzh/isync-1.4.4
abs_top_srcdir = /home/yizhi.fzh/isync-1.4.4
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/yizhi.fzh/isync-1.4.4/install-sh
...
stamp-h1: $(srcdir)/autodefs.h.in $(top_builddir)/config.status
	@rm -f stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status autodefs.h
$(srcdir)/autodefs.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f stamp-h1
	touch $@

distclean-hdr:
	-rm -f autodefs.h stamp-h1
isync.spec: $(top_builddir)/config.status $(srcdir)/isync.spec.in
...
all-am: Makefile $(SCRIPTS) $(DATA) autodefs.h
...
.MAKE: $(am__recursive_targets) all install-am
